...
chk "tc_fn_value_call (D4 full E2012 rule)" python3 examples/mindc_mind/self_host_tc_fn_value_call_smoke.py
...
chk "tc_let_infer (T1 infer_expr_tag: let x:T=<literal> E2015)" python3 examples/mindc_mind/self_host_tc_let_infer_smoke.py
chk "tcdiff E2015-infer (ANNxRHS literal vs live mindc)" python3 examples/mindc_mind/tc_differential_fuzz.py --rule E2015 --ci
