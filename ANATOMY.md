...
**Project:** `mind`
**Files:** 2663 | **Est. tokens:** ~6,645,600
**Generated:** 2026-05-28 03:50 UTC
...
- `rules.rs` (~1430 tok, large) — Copyright 2025 STARGA Inc.
### `src/bin/`
...
- `extern_c_phase_b.rs` (~5839 tok, huge) — Copyright 2025 STARGA Inc.
