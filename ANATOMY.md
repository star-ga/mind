...
**Project:** `mind`
**Files:** 2754 | **Est. tokens:** ~6,853,569
**Generated:** 2026-06-10 03:14 UTC
...
- `Cargo.toml` (~1452 tok, large) — [package]
...
- `fixture.mind` (~183 tok, small) — Phase 6.4 emit_ir smoke fixture.
- `main.mind` (~22304 tok, huge) — examples/mindc_mind/main.mind — Phase 6.5 Stage 5 APEX driver.
- `mic3_oracle_smoke.py` (~764 tok, large) — mic@3 self-host convergence — Phase 0 gate: the Rust oracle.
- `mic3_primitives_smoke.py` (~1081 tok, large) — mic@3 self-host convergence — Phase 1 gate: pure-MIND ULEB128 / zigzag.
...
- `resolve.rs` (~5215 tok, huge) — Copyright 2025 STARGA Inc.
### `src/types/`
