...
**Project:** `mind`
**Files:** 2862 | **Est. tokens:** ~6,942,924
**Generated:** 2026-06-19 09:34 UTC
...
- `parse.rs` (~9461 tok, huge) — Copyright 2025 STARGA Inc.
### `src/ir/`

- `evidence.rs` (~1913 tok, huge) — Copyright 2025 STARGA Inc.
- `mod.rs` (~10175 tok, huge) — Copyright 2025 STARGA Inc.
...
- `generics_lowering.rs` (~1336 tok, large) — Copyright 2026 STARGA Inc. Licensed under the Apache License, Version 2.0.
