...
**Project:** `mind`
**Files:** 1821 | **Est. tokens:** ~3497774
**Generated:** 2026-09-14 05:26 UTC
...
| `src/stdlib/` | 2 | ~560 |
| `src/test/` | 4 | ~14244 |
| `src/type_checker/` | 18 | ~61675 |
| `src/type_checker/slice_abi/` | 4 | ~16944 |
| `src/types/` | 10 | ~20911 |
...
- `deref_check.rs` (~5699 tok, huge) — Copyright 2025-2026 STARGA Inc.
...
- `deref_assign_slice0.rs` (~5144 tok, huge) — Copyright 2025-2026 STARGA Inc.
