...
**Project:** `mind`
**Files:** 3207 | **Est. tokens:** ~7,711,320
...
| `examples/mindc_mind/` | 135 | ~299,567 |
...
- `tc_differential_fuzz.py` (~9693 tok, huge) — tcdiff — differential fuzzer for the self-host source-position tc-rule ports.
