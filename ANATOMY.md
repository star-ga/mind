...
**Project:** `mind`
**Files:** 1833 | **Est. tokens:** ~3,509,693
**Generated:** 2026-09-17 00:39 UTC
...
| `src/parser/` | 6 | ~25,638 |
| `src/phf/` | 1 | ~4,955 |
| `src/project/` | 18 | ~59,126 |
| `src/runtime/` | 3 | ~1,485 |
| `src/shapes/` | 2 | ~6,052 |
| `src/stdlib/` | 2 | ~560 |
| `src/test/` | 4 | ~14,244 |
| `src/type_checker/` | 19 | ~62,680 |
| `src/type_checker/slice_abi/` | 4 | ~19,840 |
| `src/types/` | 10 | ~20,911 |
...
| `tests/cross_substrate_identity/` | 2 | ~4,371 |
...
- `closure_children.rs` (~3306 tok, huge) — Copyright 2025 STARGA Inc.
...
- `narrow_scan.rs` (~3084 tok, huge) — Module-wide narrow-int SURFACE prescan (compile-speed early-skip).
...
- `canonical_bridge.rs` (~5997 tok, huge) — Copyright 2026 STARGA Inc.
...
- `nerve_walk.rs` (~2270 tok, huge) — Copyright 2025 STARGA Inc.
...
- `resolve.rs` (~15202 tok, huge) — Copyright 2025 STARGA Inc.
...
- `deref_check.rs` (~8595 tok, huge) — Copyright 2025-2026 STARGA Inc.
...
- `deref_assign_slice0_formal_keyed.rs` (~5275 tok, huge) — Copyright 2025-2026 STARGA Inc.
- `deref_assign_slice0.rs` (~3945 tok, huge) — Copyright 2025-2026 STARGA Inc.
...
- `module_size_ratchet.rs` (~3975 tok, huge) — Copyright 2025 STARGA Inc.
