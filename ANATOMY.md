...
**Project:** `mind`
**Files:** 2836 | **Est. tokens:** ~6,892,476
**Generated:** 2026-06-14 05:54 UTC
...
- `mod.rs` (~18423 tok, huge) — Copyright 2025 STARGA Inc.
...
- `GAPS.md` (~1578 tok, huge) — Self-host nfn driver — gap inventory (fuzz-discovered)
