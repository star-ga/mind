...
**Project:** `mind`
**Files:** 1821 | **Est. tokens:** ~3498363
**Generated:** 2026-09-14 05:40 UTC
...
| `src/type_checker/slice_abi/` | 4 | ~17207 |
| `src/types/` | 10 | ~20911 |
...
- `deref_check.rs` (~5962 tok, huge) — Copyright 2025-2026 STARGA Inc.
...
- `deref_assign_slice0.rs` (~5470 tok, huge) — Copyright 2025-2026 STARGA Inc.
