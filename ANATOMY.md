...
**Project:** `mind`
**Files:** 1827 | **Est. tokens:** ~3,513,160
**Generated:** 2026-09-17 07:39 UTC
...
| `src/ir/frozen_profile/` | 2 | ~11,633 |
| `src/ir/frozen_profile/unsigned_taint/` | 1 | ~902 |
| `src/lint/` | 2 | ~4,001 |
...
- `signed_div_mod_edge_corpus.tsv` (~985 tok, large) — # Signed i64 div/mod edge corpus — ONE source of truth for three tiers.
...
- `mask.rs` (~902 tok, large) — Copyright 2025 STARGA Inc.
### `src/ir/frozen_profile/`

- `unsigned_taint_pipeline_tests.rs` (~3725 tok, huge) — Copyright 2025 STARGA Inc.
- `unsigned_taint.rs` (~7908 tok, huge) — Copyright 2025 STARGA Inc.
### `src/ir/`
...
- `fold.rs` (~2230 tok, huge) — Copyright 2025 STARGA Inc.
- `ir_canonical.rs` (~5715 tok, huge) — Copyright 2025 STARGA Inc.
...
- `const_folding.rs` (~829 tok, large) — Copyright 2025 STARGA Inc.
...
- `expr_parser.rs` (~1045 tok, large) — Copyright 2025 STARGA Inc.
...
- `native_closure_admission.rs` (~4054 tok, huge) — Copyright 2025 STARGA Inc.
