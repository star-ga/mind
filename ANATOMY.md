...
**Project:** `mind`
**Files:** 3212 | **Est. tokens:** ~7,734,239
**Generated:** 2026-07-25 20:46 UTC
...
| `examples/mindc_mind/` | 139 | ~318,592 |
...
- `self_host_failclosed_smoke.py` (~5520 tok, huge) — self_host_failclosed_smoke.py — the fail-closed boundary of the pure-MIND
