...
**Project:** `mind`
**Files:** 3114 | **Est. tokens:** ~7,462,547
**Generated:** 2026-07-14 15:35 UTC
...
| `examples/mindc_mind/` | 69 | ~121,413 |
...
- `self_host_native_fp_call_smoke.py` (~3123 tok, huge) — RI-D2 S-C1: FLOAT call-RETURN dtype through the native-ELF general nb_expr lowering.
