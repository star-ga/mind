...
**Project:** `mind`
**Files:** 2685 | **Est. tokens:** ~6,725,952
**Generated:** 2026-06-01 17:29 UTC
...
- `iouring.mind` (~3767 tok, huge) — std.iouring — minimal io_uring binding (Linux). The physical-I/O reap source
...
- `std_surface_iouring.rs` (~1225 tok, large) — Copyright 2025 STARGA Inc.
