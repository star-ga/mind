...
**Project:** `mind`
**Files:** 3372 | **Est. tokens:** ~7,891,721
...
- `determinism.md` (~3992 tok, huge) — The Determinism Contract
...
- `mlir_build.rs` (~9539 tok, huge) — Copyright 2025 STARGA Inc.
...
- `mod.rs` (~1333 tok, large) — Copyright 2025 STARGA Inc.
...
- `emit.rs` (~11184 tok, huge) — Copyright 2025 STARGA Inc.
- `mldsa.rs` (~1510 tok, huge) — Copyright 2025 STARGA Inc.
- `mod.rs` (~13957 tok, huge) — Copyright 2025 STARGA Inc.
- `parse.rs` (~11907 tok, huge) — Copyright 2025 STARGA Inc.
### `src/ir/`
...
- `mod.rs` (~15138 tok, huge) — Copyright 2025 STARGA Inc.
- `print.rs` (~4283 tok, huge) — Copyright 2025 STARGA Inc.
- `verify.rs` (~18300 tok, huge) — Copyright 2025 STARGA Inc.
### `src/`
...
- `extern_narrow_ret_run.rs` (~1578 tok, huge) — Copyright 2025 STARGA Inc.
...
- `narrow_locals_leak_run.rs` (~1643 tok, huge) — Copyright 2025 STARGA Inc.
...
- `return_cond_type_reject.rs` (~8752 tok, huge) — Copyright 2025 STARGA Inc.
