...
**Project:** `mind`
**Files:** 3212 | **Est. tokens:** ~7,737,548
**Generated:** 2026-07-25 23:28 UTC
...
| `examples/mindc_mind/` | 139 | ~321,392 |
...
- `self_host_failclosed_smoke.py` (~8320 tok, huge) — self_host_failclosed_smoke.py — the fail-closed boundary of the pure-MIND
