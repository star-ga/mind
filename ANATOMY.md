...
**Project:** `mind`
**Files:** 2602 | **Est. tokens:** ~6,444,063
**Generated:** 2026-05-21 20:13 UTC
...
- `STATUS.md` (~1972 tok, huge) — MIND Compiler Status
...
- `0010-memory-safety-and-c-abi.md` (~6909 tok, huge) — RFC 0010: Memory Safety Model + C ABI in Pure MIND
