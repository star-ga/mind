...
**Project:** `mind`
**Files:** 3169 | **Est. tokens:** ~7,572,087
**Generated:** 2026-07-22 03:37 UTC
...
| `examples/mindc_mind/` | 92 | ~159,854 |
...
- `INDEPENDENCE_ROADMAP.md` (~5863 tok, huge) — MIND Rust-Independence Roadmap
...
- `fast_keystone.sh` (~1850 tok, huge) — fast_keystone.sh — fast LOCAL front-end keystone gate for the pure-MIND self-host
