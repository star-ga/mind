...
**Project:** `mind`
**Files:** 2685 | **Est. tokens:** ~6,728,703
**Generated:** 2026-06-01 17:53 UTC
...
- `mindc.rs` (~13481 tok, huge) — Copyright 2025 STARGA Inc.
### `src/build/`
...
- `lower.rs` (~25044 tok, huge) — Copyright 2025 STARGA Inc.
- `mlir_build.rs` (~6871 tok, huge) — Copyright 2025 STARGA Inc.
...
- `parse.rs` (~7772 tok, huge) — Copyright 2025 STARGA Inc.
### `src/ir/compact/v2/`
...
- `naming_convention.rs` (~1848 tok, huge) — Copyright 2025 STARGA Inc.
- `q16_overflow.rs` (~2549 tok, huge) — Copyright 2025 STARGA Inc.
- `shadowing.rs` (~1785 tok, huge) — Copyright 2025 STARGA Inc.
...
- `mod.rs` (~16888 tok, huge) — Copyright 2025 STARGA Inc.
...
- `iouring.mind` (~5205 tok, huge) — std.iouring — minimal io_uring binding (Linux). The physical-I/O reap source
...
- `cross_module_cdylib_compose.rs` (~3204 tok, huge) — Copyright 2025 STARGA Inc.
...
- `std_surface_iouring.rs` (~1438 tok, large) — Copyright 2025 STARGA Inc.
...
- `std_surface_reactor.rs` (~1332 tok, large) — Copyright 2025 STARGA Inc.
