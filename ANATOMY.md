...
**Project:** `mind`
**Files:** 3211 | **Est. tokens:** ~7,731,212
...
| `examples/mindc_mind/` | 138 | ~315,565 |
...
- `self_host_failclosed_smoke.py` (~4287 tok, huge) — self_host_failclosed_smoke.py — the fail-closed boundary of the pure-MIND
