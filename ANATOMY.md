...
- `iouring.mind` (~4413 tok, huge) — std.iouring — minimal io_uring binding (Linux). The physical-I/O reap source
...
- `std_surface_iouring.rs` (~1354 tok, large) — Copyright 2025 STARGA Inc.
