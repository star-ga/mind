...
**Project:** `mind`
**Files:** 2762 | **Est. tokens:** ~6,865,223
**Generated:** 2026-06-11 02:15 UTC
...
- `roadmap.md` (~13461 tok, huge) — Roadmap
...
- `mic3_primitives_smoke.py` (~21907 tok, huge) — mic@3 self-host convergence — Phase 1 gate: pure-MIND ULEB128 / zigzag.
