...
**Project:** `mind`
**Files:** 3384 | **Est. tokens:** ~7,967,395
**Generated:** 2026-08-27 00:54 UTC
...
- `INDEPENDENCE_ROADMAP.md` (~18319 tok, huge) — MIND Rust-Independence Roadmap
...
- `check_no_ai_attribution.sh` (~543 tok, large) — Public-artifact hygiene gate: no AI tool/model named as having AUTHORED or
...
- `native_opt.rs` (~10126 tok, huge) — Copyright 2025 STARGA Inc.
