...
**Project:** `mind`
**Files:** 2685 | **Est. tokens:** ~6,742,216
...
- `iouring.mind` (~17011 tok, huge) — std.iouring — minimal io_uring binding (Linux). The physical-I/O reap source
...
- `std_surface_iouring.rs` (~2820 tok, huge) — Copyright 2025 STARGA Inc.
