...
**Project:** `mind`
**Files:** 3160 | **Est. tokens:** ~7,556,447
**Generated:** 2026-07-21 18:03 UTC
...
| `examples/mindc_mind/` | 83 | ~146,651 |
...
- `INDEPENDENCE_ROADMAP.md` (~3933 tok, huge) — MIND Rust-Independence Roadmap
...
- `fast_keystone.sh` (~1608 tok, huge) — fast_keystone.sh — fast LOCAL front-end keystone gate for the pure-MIND self-host
