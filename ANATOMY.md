...
**Project:** `mind`
**Files:** 3212 | **Est. tokens:** ~7,735,565
**Generated:** 2026-07-25 22:10 UTC
...
| `examples/mindc_mind/` | 139 | ~319,409 |
...
- `self_host_failclosed_smoke.py` (~6337 tok, huge) — self_host_failclosed_smoke.py — the fail-closed boundary of the pure-MIND
