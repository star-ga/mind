...
**Project:** `mind`
**Files:** 3037 | **Est. tokens:** ~7,283,038
**Generated:** 2026-07-06 17:20 UTC
...
- `_ported_mind_check.mind` (~253 tok, medium) — harness: exercise the ported divergent kernel across the boundary grid
### `examples/emit_ir/`
...
- `mod.rs` (~6813 tok, huge) — Copyright 2025 STARGA Inc.
### `src/cache/`
...
- `mlir_build.rs` (~8783 tok, huge) — Copyright 2025 STARGA Inc.
