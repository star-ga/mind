...
**Project:** `mind`
**Files:** 3212 | **Est. tokens:** ~7,735,173
**Generated:** 2026-07-25 21:51 UTC
...
| `examples/mindc_mind/` | 139 | ~319,017 |
...
- `self_host_failclosed_smoke.py` (~5945 tok, huge) — self_host_failclosed_smoke.py — the fail-closed boundary of the pure-MIND
