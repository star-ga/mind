...
| 2 | evolutionary search (AB-MCTS) on the ONE hard kernel — the structural pack; fitness = (oracle-identity ∧ cross-substrate index-hash-equal ∧ objdump-pure) hard gates × internal GB/s. Rung **L1** of the ladder in [`self-evolution.md`](./self-evolution.md) | x86 `format-structural-index` blessed | mind-det-gemm + MIND research |
...
4c. **`mic@4` — a MIND-research-evolved successor wire format.** Rung **L2** of the
   ladder in [`self-evolution.md`](./self-evolution.md). Once
