...
pub(super) fn lower_expr_inner(
    ...
    match node {
        ...
        // Struct field reads use the shared resolver and fixed-array ABI helper.
        #[cfg(feature = "std-surface")]
        ast::Node::FieldAccess {
            receiver,
            field,
            span,
        } => field_access::lower_field_access(
            receiver.as_ref(),
            field,
            span,
            ir,
        ...
        // Struct field assignments share the read resolver and mutate cells in place.
        #[cfg(feature = "std-surface")]
        ast::Node::FieldAssign {
            receiver,
            field,
            value,
            span,
        } => field_access::lower_field_assign(
            receiver.as_ref(),
            field,
            value,
            span,
