...
| Self-hosted compiler — **front-end** now a fully general `mic@3` emitter (byte-exact on the whole 66-fixture corpus, not just its own source: 0 fail-closed, 0 wrong-bytes; real-codegen self-host still in progress) | ✅ Complete | v0.6.1 | `examples/mindc_mind/` |
